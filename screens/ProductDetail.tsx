...
import { PressableStateCallbackType, SafeAreaView } from "react-native";
...
const data: ProductTypes[] = [
    {
        productName: "เก้าอี้",
        productDetail: "เก้าอี้คุณภาพชั้นดี ชั้นวางข้างเตียง เปิดให้เช่าแค่รายเดือนนะครับ บริการส่งฟรีรอบรั้วมหาวิทยาลัย ขออนุญาตเก็บค่ามัดจำล่วงหน้า 1 เดือนครับ",
        productCost: 20,
        productUrl: "",
        productImage:
